...
#origen_space
tfidf_matrix_origen = np.load('/home/ignacio/Datasets/Amazon/Data cleaned/Embedding/GLoVe/movie_embedding_space.npy')

#target_space
tfidf_matrix_target = np.load('/home/ignacio/Datasets/Amazon/Data cleaned/Embedding/GLoVe/book_embedding_space.npy')

#user_space
users_profiles_matrix = np.load('/home/ignacio/Datasets/Amazon/Data cleaned/Embedding/GLoVe/user_embedding_space.npy')
...
for user in users_to_recommend:
    ...
    df_recomendation.to_csv(
        '/home/ignacio/Datasets/Amazon/Data cleaned/Recommendation/Embedding/GLoVe/recommendation_embedding_space_'+user+'.csv', index='False')
