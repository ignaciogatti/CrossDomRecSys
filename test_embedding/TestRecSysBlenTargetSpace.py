...
#origen_space
tfidf_matrix_origen = np.load('/home/ignacio/Datasets/Amazon/Data cleaned/Embedding/W2B/Target to Origin space/movie_space.npy')

#target_space
tfidf_matrix_target = np.load('/home/ignacio/Datasets/Amazon/Data cleaned/Embedding/W2B/Target to Origin space/book_space.npy')

#user_space
users_profiles_matrix = np.load('/home/ignacio/Datasets/Amazon/Data cleaned/Embedding/W2B/Target to Origin space/user_space.npy')
...
for user in users_to_recommend:
    ...
    df_recomendation.to_csv(
        '/home/ignacio/Datasets/Amazon/Data cleaned/Recommendation/Embedding/W2B/Blend/recommendation_book_to_origin_space_'+user+'.csv', index='False')
